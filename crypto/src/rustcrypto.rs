...
use crate::{
    ...
    hkdf::*,
    Cdi, Crypto, CryptoError, CryptoSuite, Digest, DigestAlgorithm, DigestType, ExportedCdiHandle,
...
impl crate::Cdi for RustCryptoCdi {
    fn derive_key_pair(
        &mut self,
        label: &[u8],
        info: &[u8],
...
impl Crypto for RustCryptoImpl {
    ...
    fn derive_cdi(
        ...
        measurement: &Digest,
        info: &[u8],
    ) -> Result<&mut dyn crate::Cdi, CryptoError> {
